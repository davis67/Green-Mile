      ...
      <div className="hidden md:flex md:flex-shrink-0">
        <div className="flex flex-col w-64">
          <div className="flex items-center h-16 flex-shrink-0 px-4 bg-gray-900">
            <span className="text-white">Green Mile Project</span>
          </div>
          <div className="h-0 flex-1 flex flex-col overflow-y-auto">
            <nav className="flex-1 px-2 py-4 bg-gray-800">
              <a
                href="#"
                className="group flex items-center px-2 py-2 text-sm leading-8 tracking-wider font-medium text-white rounded-md bg-gray-900 hover:underline focus:bg-gray-700 focus:underline transition ease-in-out duration-150"
              >
                <svg
